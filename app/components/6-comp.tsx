        ...
        <div className="grid grid-cols-2 grid-rows-2 min-h-[700px]">
          ...
          <div className="p-12 pr-16 space-y-16">
            <div>
              ...
              <p className="text-sm max-w-sm text-primary-color-text">
                Real-time execution status of autonomous agents.
              </p>
            </div>
          ...
          <div className="p-12 pl-16 space-y-8">
            ...
            <div className="space-y-3 max-w-md">
              ...
              <h2 className="text-2xl font-semibold text-foreground leading-snug">
                Visibility across autonomous execution
              </h2>

              <p className="text-sm text-muted-foreground leading-relaxed">
                Monitor how agents transition between operational states as
                workflows execute—providing immediate insight into activity,
                stability, and overall system behavior.
              </p>
            </div>

            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• Continuous streaming of execution state changes</li>
              <li>• Instant identification of idle or paused processes</li>
              <li>• Real-time awareness of workflow progression</li>
              <li>• Faster operational debugging and incident response</li>
              <li>• Improved reliability across multi-agent systems</li>
            </ul>
          ...
          <div className="p-12 pr-16 space-y-8">
            ...
            <div className="space-y-3 max-w-md">
              ...
              <h2 className="text-2xl font-semibold text-foreground leading-snug">
                Controlled delivery through layered validation
              </h2>

              <p className="text-sm text-muted-foreground leading-relaxed">
                Every generated response is evaluated through sequential
                protection layers that enforce brand alignment, regulatory
                compliance, and content safety before reaching production.
              </p>
            </div>

            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• Automated enforcement of tone and policy rules</li>
              <li>• Prevention of unsafe or non-compliant outputs</li>
              <li>• Transparent validation across the response lifecycle</li>
              <li>• Reduced operational and legal risk in deployment</li>
              <li>• Trustworthy AI behavior at production scale</li>
            </ul>
          ...
          <div className="p-12 pl-16 space-y-14">
            <div>
              ...
              <p className="text-sm max-w-sm text-primary-color-text">
                Validation layer applied before output goes live.
              </p>
            </div>
