...
export const LogoStepper: React.FC<LogoStepperProps> = ({
  ...
  return (
    <div className='relative w-full flex items-start justify-center overflow-hidden py-20'>
      <div
        ...
        <AnimatePresence initial={false} mode='popLayout'>
          {visibleLogos.map(({ logo, originalIndex, position }) => {
            ...
            return (
              ...
              >
                <motion.div className='rounded-xl border border-border bg-card p-6 hover:border-primary transition-colors'>
