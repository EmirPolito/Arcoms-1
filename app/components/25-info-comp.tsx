...
export default function Component25() {
    return (
        <section>
            <div className="bg-neutral-950 py-25 md:py-20">
                <div className="mx-auto flex flex-col px-1 md:grid md:max-w-6xl md:grid-cols-2 md:gap-10">
