...
export default function LogoCloud() {
    return (
        <section className="bg-logos-bg overflow-hidden py-10">
            <div className="group relative m-auto max-w-8xl px-15">
                <div className="flex flex-col items-center md:flex-row">
                    <div className="md:max-w-44 md:border-r md:pr-4">
                        <p className="text-end text-sm text-logos-txt">Desarrollado con las siguientes tecnologías</p>
                    </div>
                    <div className="relative py-7 md:w-[calc(100%-11rem)]">
                        ...
                        <div className="bg-linear-to-r from-logos-bg absolute inset-y-0 left-0 w-20"></div>
                        <div className="bg-linear-to-l from-logos-bg absolute inset-y-0 right-0 w-20"></div>
                        <ProgressiveBlur
