...
export function TarjetaPines() {
  return (
    <div className="w-full flex items-center justify-center py-11 px-4" style={{ contain: "layout style" }}>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 sm:gap-14 lg:gap-20">
        {/* TARJETA 1 */}
        <PinContainer title="Descripcion1/" href="/">
          <div className="flex basis-full flex-col p-4 tracking-tight text-primary-color-text w-[16rem] h-[16rem] sm:w-[18rem] sm:h-[18rem] lg:w-[20rem] lg:h-[20rem]">
        ...
        <PinContainer title="Descripcion2/" href="/">
          <div className="flex basis-full flex-col p-4 tracking-tight text-foreground/60 w-[16rem] h-[16rem] sm:w-[18rem] sm:h-[18rem] lg:w-[20rem] lg:h-[20rem]">
            <h3 className="max-w-xs pb-2 m-0 font-bold text-base text-foreground">
              Titulo 2
            </h3>
